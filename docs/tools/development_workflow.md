> 🇪🇸 [Leer en Español](development_workflow.es.md) | 🇺🇸 **English**

# Development Workflow

## Optimized Jupyter Lab Setup

### Jupyter Lab Configuration
```python
# scripts/setup_jupyter.py
"""
Optimized Jupyter Lab configuration for trading development
"""
...
def setup_jupyter_config():
    """Configure Jupyter Lab for trading"""
    
    # Jupyter Lab configuration
    jupyter_config = {
        "notebook": {
            "Completer": {
                "use_jedi": False  # Better autocompletion
            }
        },
        "lab": {
            "shortcuts": [
    ...
    print("⚙️  Configuring Jupyter Lab...")
    ...
    print("🚀 Jupyter Lab configured for trading!")

# Function to create notebook template
def create_notebook_template():
    """Create standard template for trading notebooks"""
...
# Function to generate notebook from template
...
echo "🔧 Configuring Git for trading project..."
...
### Git Hooks for Trading Projects
```python
# scripts/setup_git_hooks.py
"""
Setup Git hooks specific to trading projects
"""
...
def create_pre_commit_hook():
    """Create pre-commit hook for validations"""
    
    hook_content = '''#!/usr/bin/env python3
"""
Pre-commit hook to validate trading code
"""
...
def check_api_keys():
    """Verify that API keys are not uploaded"""
        ...
        if file.endswith('.py') and os.path.exists(file):
            ...
            for pattern in dangerous_patterns:
                ...
                if re.search(pattern, content, re.IGNORECASE):
                    print(f"❌ DANGER: Possible API key in {file}")
...
def check_notebook_outputs():
    """Verify that notebooks do not have outputs"""
...
def create_commit_msg_hook():
    ...
    hook_content = '''#!/usr/bin/env python3
"""
Commit message hook to enforce conventions
"""
...
def validate_commit_message(msg):
    ...
    # Example: feat(strategy): add VWAP reclaim strategy
    ...
    if not re.match(pattern, msg):
        ...
        print("Example: feat(strategy): add VWAP reclaim strategy")
        return False
...
class TestCustomIndicators(unittest.TestCase):
    ...
    def test_relative_volume(self):
        ...
        # Valid values after the lookback period
    ...
    def test_gap_percentage(self):
        ...
        # Subsequent values should be numeric
...
class TestDataValidation(unittest.TestCase):
    ...
    def test_data_integrity(self):
        ...
        # Data with high < low (invalid)
        bad_data = pd.DataFrame({
            'open': [100] * 10,
            'high': [95] * 10,  # High less than low
            'low': [98] * 10,
            'close': [97] * 10,
            'volume': [1000] * 10
        }, index=dates)
...
class TestTradingSystemIntegration(unittest.TestCase):
    ...
    def test_data_to_signals_pipeline(self):
        """Test pipeline from data to signals"""
        ...
        def full_pipeline(data):
            ...
            # Simple signal: price > SMA and RSI < 70 and high volume
            signals['long_signal'] = (
    ...
    def test_data_provider_fallback(self, mock_get):
        ...
        mock_get.side_effect = [
            ...
            Mock(status_code=200, json=lambda: {'price': 150.0})  # Second succeeds
        ]
        
        # Simulate UnifiedDataProvider
    ...
    def test_risk_management_integration(self):
        ...
        self.assertLessEqual(position_size * 100, 75000 * 0.2)  # Respects exposure limit
...
This development workflow provides a solid foundation for developing, testing, and maintaining quantitative trading systems in a professional and collaborative manner.